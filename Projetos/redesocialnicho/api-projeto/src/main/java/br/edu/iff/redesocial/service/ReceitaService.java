...
public class ReceitaService {
    ...
    public ReceitaResponseDTO criar(ReceitaRequestDTO dto) {
        Usuario autor = usuarioRepository.findById(dto.autorId())
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Autor não encontrado com o ID fornecido"));
    ...
    public void deletar(Long id) {
        ...
        if (!receitaRepository.existsById(id)) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Receita não encontrada para exclusão");
        }
